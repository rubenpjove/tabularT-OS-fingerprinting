...
# p = 0.01  # 10% of the lines - Around xxxx rows
...
my_show_df_shape(df)
my_show_df_NaNs(df)
assert set(df.columns) == set(FEATURES + LABEL), "Columns in df do not match FEATURES + NUMERICAL_FEATURES + CATEGORICAL_FEATURES"
